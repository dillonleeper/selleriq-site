...
const operatingLayers = [
  ...
  { number: "03", icon: Workflow, label: "ACT", title: "Turn insight into an operating queue.", body: "SellerIQ translates analysis into specific moves: what to reorder, where to transfer, which campaign to trim, and which SKU needs attention first.", proof: ["Dollar impact", "Clear owner", "One-click workflow"] },
];
